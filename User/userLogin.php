...
$sql ="SELECT u_email,u_password FROM userlogin_tb 
WHERE u_email ='".$rEmail."' AND u_password =
'".$rPassword."'limit 1";
...
<p class="text-center" style="font-size:20px;"> <i class="fas fa-tools text-danger"></i>User Area(Demo)</p>
